...
Finally, the default resolution is 320x180, if you would like to change it, edit the following line of code (Currently line
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwNDE3OTc2OV19
-->